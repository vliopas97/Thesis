...
namespace sl {
    ...
    public:
        ...
        \note Supported \ref MAT_TYPE are : 
                ...
                \ref MAT_TYPE::U8_C4 for PNG/JPG,
         */
        ERROR_CODE write(const String &filePath, sl::MEM memory_type = sl::MEM::CPU);
    ...
    struct CameraInformation {
        ...
        sl::Transform camera_imu_transform; /**< IMU to Left camera transform matrix, that contains rotation and translation between IMU frame and camera frame. Note that this transform was applied to the fused quaternion provided in getIMUData() in v2.4 but not anymore starting from v2.5. See \ref getSensorsData() for more info.*/
        unsigned int serial_number = 0; /**< The serial number of the camera.  */
        unsigned int camera_firmware_version = 0; /**< The internal firmware version of the camera. */
        unsigned int sensors_firmware_version = 0; /**< The internal firmware version of the sensors of ZED-M or ZED2. */
...
#define ZED_SDK_BUILD_ID "18502_f4ccc873"
...
namespace sl {
    ...
    public:
        ...
        \n default : (-1) corresponding to 700 mm for a ZED and 300 mm for ZED Mini.
    ...
    public:
        ...
        RuntimeParameters(SENSING_MODE sensing_mode_ = SENSING_MODE::STANDARD,
                ...
                int textureness_confidence_threshold_ = 100,
        ...
        , textureness_confidence_threshold(textureness_confidence_threshold_)
    ...
    struct /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/StreamingParameters {
        ...
        \note Default value is 32768. You can lower this value if network generates a lot of packet lost : this will
         ...
         */
        unsigned short chunk_size = 32768;
    ...
    struct /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/ObjectDetectionParameters {
         ...
         */
        bool image_sync = true; // data synchronized
        ...
        \brief Default constructor. Set all parameters to their default values
         */
        ObjectDetectionParameters(bool image_sync_ = true, bool enable_tracking_ = true, bool enable_mask_output_ = false);
    };
    ...
    public:
        ...
        \return \ref "SUCCESS" if the method succeeded,
                ...
                \ref ERROR_CODE "ERROR_CODE::INVALID_RESOLUTION" if the width/height is higher than camera.getResolution() or camera.getResolution() x 2 for side by side view mode (not supported),
        ...
        \code
        //Set the gain to 50
        zed.setCameraSettings(CAMERA_SETTINGS::GAIN, 50);
        \endcode
        ...
        Calling getSensosrData with \ref TIME_REFERENCE "TIME_REFERENCE::CURRENT" gives you the latest sensors data received. Getting all the data requires to call this function at 800Hz in a thread.
