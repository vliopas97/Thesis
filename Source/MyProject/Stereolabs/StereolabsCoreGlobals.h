...
extern uint32 GSlGrabThreadId;

/** True if the grab thread has been initialized */
extern bool GSlIsGrabThreadIdInitialized;

/** Eye half baseline of the Zed */
extern float GSlEyeHalfBaseline;

/** Camera proxy instance */
extern class USlCameraProxy* GSlCameraProxy;
